...
function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setIsSuccess(true);
            setMessage(response.message || "Registration completed successfully!");
            setTimeout(() => {
                navigate("/");
            }, 1800);
        } catch (error) {
                ...
                >
                    ...
                    <div className="flex flex-col items-center text-center mb-8">
                        ...
                        <p className="text-sm text-[#AAB3C5] mt-2">
                            Join MailOS and draft emails fast.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative group">
                            ...
                            />
                            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-[#AAB3C5] group-focus-within:text-[#6C63FF] transition duration-300" size={16} />
                            <label 
                                htmlFor="name"
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full mt-4 flex items-center justify-center gap-2 py-4 rounded-2xl font-bold bg-[#6C63FF] text-white cursor-pointer shadow-lg shadow-[#6C63FF]/25 hover:shadow-[#6C63FF]/45 transition duration-300 disabled:opacity-50"
                        >
                            <span>{loading ? "Registering..." : isSuccess ? "Done" : "Register Account"}</span>
                            <ArrowRight size={16} />
                        </motion.button>
                    </form>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs text-[#AAB3C5]">
                            ...
                            <Link to="/" className="text-[#6C63FF] hover:underline font-semibold cursor-pointer">
                                Sign In
                            </Link>
                        </p>
                    </div>
